package com.snh.chat.core.group;
 ...
 * 实现ChannelGroup
 */
public class ChatChannelGroup extends AbstractSet<Channel> implements ChannelGroup {
     ...
     */
    public ChatChannelGroup(EventExecutor executor, boolean stayClosed) {
     ...
     */
    public ChatChannelGroup(String name, EventExecutor executor, boolean stayClosed) {
        if (name == null) {
